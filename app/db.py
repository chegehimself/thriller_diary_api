...
class Connection(object):
    ...
    def __init__(self):
        ...
        # psql -U ghhsmxok -h pellefant.db.elephantsql.com -p xOIcbusOqu4s7eR9vIMo811WcMgumiQx -p 5432 -d ghhsmxok
        # local connection
        ...
        self.HOSTNAME = 'pellefant.db.elephantsql.com'
        self.USERNAME = 'ghhsmxok'
        self.DATABASE = 'ghhsmxok'
        self.PASSWORD = 'xOIcbusOqu4s7eR9vIMo811WcMgumiQx'
